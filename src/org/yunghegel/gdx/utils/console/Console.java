...
public interface Console {
    ...
    /**
     * Makes the console also log to the System when {@link com.strongjoshua.console.Console#log(String)} is called.
     *
    ...
    /**
     * @return {@link InputProcessor} for this {@link com.strongjoshua.console.Console}
     */
    ...
    /**
     * Calls {@link com.strongjoshua.console.Console#refresh(boolean)} with true.
     */
    void refresh ();
     ...
     *
     * @param msg The message to be logged.
     * @see com.strongjoshua.console.LogLevel
    ...
    /**
     * @param code The new key's ID. Cannot be {@link Input.Keys#ENTER}.
     * @see com.strongjoshua.console.Console#getDisplayKeyID()
     */
