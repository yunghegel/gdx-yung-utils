...
public class UI {
    ...
    public static <T extends VisSlider> T changeCompleted(T slider, Consumer<ChangeEvent> handler){
    ...
    public static VisSlider sliderTable(VisTable table, String name, float min, float max, float value, ControlScale scale, Consumer<Float> setter) {
        float width = 150;
    ...
    public static VisSlider slider(VisTable table, String name, float min, float max, float val, ControlScale scale, Consumer<Float> callback) {
        VisTable t = new VisTable();
        t.defaults().pad(2);
